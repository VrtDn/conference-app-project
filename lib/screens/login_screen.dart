...
class _LoginPageState extends State<LoginPage> {
  ...
  InputDecoration _buildInputDecoration(
      String label, IconData icon, bool needVisibilityOption) {
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: _buildInputDecoration(
                            "Your email", Icons.email_outlined, false),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      TextFormField(
                        ...
                        decoration: _buildInputDecoration("Your password",
                            Icons.remove_red_eye_outlined, true),
                      ),
                      const SizedBox(
                        height: 165,
                      ),
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            isLoaded ? print("Loading") : _submitForm();
                          },
                          child: isLoaded
